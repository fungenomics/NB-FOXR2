...
```{r plot_ssgsea_enrichment_celltype_neurons, fig.height = 4, fig.width=30, cache = F}
...
```{r plot_ssgsea_enrichment_celltype_glia, fig.height = 4, fig.width=30, cache = F}
